...
const experiences: Experience[] = [
  {
    ...
    description:
      "Building secure, scalable government identity platforms across a wide stack — from legacy .NET + Flutter to current Java microservices + Web, plus Rust and mobile biometrics — covering the full lifecycle from requirements and architecture to deployment and live ops for ePassports, visas and election/biometric systems.",
    highlights: [
